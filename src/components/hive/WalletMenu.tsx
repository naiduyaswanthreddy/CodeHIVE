  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <Button variant="outline" size="sm" className="flex items-center gap-2 border-input text-foreground">
          {isRefreshing ? (
          ...
          <div className="flex flex-col items-start">
            <span className="text-xs text-foreground">@{connectedUser}</span>
